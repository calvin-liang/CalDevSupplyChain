...
INSERT INTO email_templates (created_on, last_modified, locale, subject, to_email, from_email, content, type)
  VALUES (CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'en_US', 'Registration Activation Link', NULL, NULL, '<a href=http://localhost:3000/activating/{token}>Activate Account Confirmation Link', 'ACTIVATION');
INSERT INTO email_templates (created_on, last_modified, locale, subject, to_email, from_email, content, type)
