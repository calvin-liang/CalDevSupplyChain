// TODO: Login Form - same as Signup Form, tweak some logic
...
//       [classes.submitButton]: !this.props.logining || this.props.success,
//       [classes.disableButton]: this.state.formError || this.props.logining ,
//     })
//
//     return (
...
//             {this.props.logining && <LinearProgress style={{backgroundColor: "#b2edfc"}}
//               classes={{
...
//                       <Button
//                         raised
//                         disabled={this.state.formError || this.props.logining || this.props.success}
